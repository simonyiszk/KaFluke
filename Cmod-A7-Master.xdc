...
set_property LOC A17 [get_ports {led_1_o}]
...
set_property LOC C16 [get_ports {led_2_o}]
...
set_property LOC B17 [get_ports {bled}]
set_property IOSTANDARD LVCMOS33 [get_ports {bled}]
set_property LOC B16 [get_ports {gled}]
set_property IOSTANDARD LVCMOS33 [get_ports {gled}]
set_property LOC C17 [get_ports {rled}]
...
set_property LOC A18 [get_ports {btn_0_i}]
set_property IOSTANDARD LVCMOS33 [get_ports {btn_0_i}]
#set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L19P_T3_16 Sch=btn[1]
set_property LOC B18 [get_ports {btn_1_i}]
set_property IOSTANDARD LVCMOS33 [get_ports {btn_1_i}]

## Pmod Header JA
# set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { pulse_o }]; #IO_L5N_T0_D07_14 Sch=ja[1]
set_property LOC G17 [get_ports {pulse_o}]
